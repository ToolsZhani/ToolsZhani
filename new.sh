...
echo
echo $pur"==================="$cy" ==================="
echo $i""$pu"  AUTHOR  :  Z HAHANI                "$i"  "
echo $i""$pu"  WhatsApp:  0895375872878"$i"              "
echo $i""$pu"  GMAIL   :  muhamadbadruwasih8@gmail.com"$i" "
echo $pur"==================="$cy" ==================="
echo
